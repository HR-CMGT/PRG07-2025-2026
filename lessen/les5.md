...
- [Les 5](#les-5)
  - [Maps](#maps)
  - [Location](#location)
    - [Coarse Location (`Accuracy.Low`)](#coarse-location-locationaccuracylow)
    - [Fine Location (`Accuracy.High`)](#fine-location-locationaccuracyhigh)
...
Toon ook de huidige locatie van de gebruiker (Tip: dit kan direct via de `MapView`). De app heeft daarvoor permissies nodig, die je kunt laten aanvragen door de app via de Location API. Voor deze opdracht is het echter makkelijker om via de instellingen van de telefoon de app toegang te geven tot locatie van de gebruiker.
